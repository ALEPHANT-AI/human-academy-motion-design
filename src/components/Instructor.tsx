...
const Instructor: React.FC = () => {
  ...
  return (
    <section ref={sectionRef} id="instructor" className="py-24">
      <div className="container">
        <h2 className="section-title text-center fade-item mb-16">
          Seu <span className="gradient-text">Instrutor</span>
        </h2>
        
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <div className="fade-item">
            <div className="relative">
              <div className="absolute -inset-4 bg-gradient-to-br from-human-orange/50 to-human-dark rounded-lg blur-lg opacity-50 group-hover:opacity-75 transition-opacity"></div>
          ...
          <div className="fade-item">
            <div className="inline-block mb-4 bg-human-orange/20 text-human-orange font-bold py-2 px-4 rounded-full">
              Motion Designer & Engenheiro Front-end
            </div>
            
            <h3 className="text-2xl md:text-3xl font-bold mb-4">Alexandre Monteiro</h3>
            
            <p className="text-human-gray mb-6">
              Designer de interação e desenvolvedor front-end com mais de 12 anos de experiência 
              trabalhando com grandes marcas e agências premiadas internacionalmente.
            </p>
            
            <ul className="space-y-3 mb-8">
              <li className="flex items-start">
                <span className="text-human-orange mr-2">✓</span>
                <span>Ex-diretor criativo da Awwwards Agency</span>
              </li>
              <li className="flex items-start">
                <span className="text-human-orange mr-2">✓</span>
                <span>Criador de 15+ sites premiados com Site of the Day</span>
              </li>
              <li className="flex items-start">
                <span className="text-human-orange mr-2">✓</span>
                <span>Especialista em GSAP e animações web de alta performance</span>
              </li>
              <li className="flex items-start">
                <span className="text-human-orange mr-2">✓</span>
                <span>Palestrante em conferências de design e desenvolvimento</span>
              </li>
            </ul>
