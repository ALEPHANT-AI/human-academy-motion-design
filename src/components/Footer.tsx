        ...
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><a href="#benefits" className="text-human-gray hover:text-white transition-colors">Benefícios</a></li>
              <li><a href="#program" className="text-human-gray hover:text-white transition-colors">Programa</a></li>
              <li><a href="#project" className="text-human-gray hover:text-white transition-colors">Projeto</a></li>
              <li><a href="#instructor" className="text-human-gray hover:text-white transition-colors">Instrutor</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="p-2 bg-white/5 hover:bg-human-orange/20 hover:text-human-orange rounded-full transition-colors">
